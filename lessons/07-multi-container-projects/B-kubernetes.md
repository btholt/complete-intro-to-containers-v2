...
![Gear in the top right](/images/kubernetes1.png)

Click the gear in the top right of the Docker Desktop app.

![Kubernetes menu, enable Kubernetes](/images/kubernetes2.png)

Navigate to the Kubernetes menu and click enable Kubernetes. You will likely have to restart Docker.

Do a `kubectl cluster-info` to make sure. You should see your control plane running.
